export const translations = {
  ...
  ar: {
    ...
    canDoItems: [
      "استيعاب أرشيفات ZIP وبيانات المجلدات",
      "توليد فهرس ملفات آمن وسياق معاينة",
      "ربط المشاريع بجلسات ذكاء اصطناعي متعددة",
      "قياس الاستخدام وتدقيق الإجراءات الحساسة",
    ],
    notSupportedYet: "غير مدعوم حاليًا",
    notSupportedItems: [
      "لا توجد طرفية أو بيئة معزولة أو تثبيت تبعيات",
      "لا توجد تعديلات تلقائية على الشيفرة أو طلبات دمج",
      "لا يوجد دعم لـ GitHub OAuth أو التضمينات أو الدفع بعد",
    ],
