export const translations = {
  en: {
    ...
    patchSandbox: "Patch preview verifier",
    verifyInSandbox: "Verify patch preview",
    ...
    sandboxLimitedToIndexedText: "Verification is limited to indexed preview text",
    before: "Before",
    after: "After",
    ...
    executedFromApprovedRequest: "Created from approved request",
    requestMustBeApprovedBeforeExecution: "Request must be approved before working-copy creation",
    executionBlocked: "Working-copy creation blocked",
    executionDoesNotDeployChanges: "Working-copy creation does not deploy changes",
    ...
    sourceWritebackReview: "Review handoff",
    requestSourceWritebackReview: "Request review handoff",
    ...
    writebackReviewWorkflow: "Review handoff workflow",
    writebackReviewWorkflowDescription:
      "Review submitted handoff requests. Approval authorizes working-copy export preparation; changes are not applied directly.",
    submittedWritebackRequests: "Submitted review handoff requests",
    ...
    approvedForFutureWritebackConsideration: "Approved for working-copy export consideration",
    ...
    openRecentSession: "Recent sessions",
    ...
    projectContextAttached: "Active project context ready",
    projectContextIsAttached: "Project context is attached",
    projectContextAttachedNoProcessedFiles: "Attached, but no processed files are available yet",
    projectContextCouldNotBeLoaded: "Project context could not be loaded",
    projectPreviewDataUnavailable: "Project preview data is unavailable",
    checkZipProcessingStatus: "Check ZIP processing status",
    projectContextNotAttached: "Active project available",
    noProjectContextAvailable: "No project available",
    attachThisProject: "Attach this project",
    attachedProject: "Attached project",
    assistantCanUseIndexedProjectContext: "Using current project context for analysis.",
    attachProjectToImproveProposals: "Attach this project to use it in this chat.",
    responsesMayBeGeneralWithoutProjectContext: "No project context. Responses will be general.",
  ...
  ar: {
    ...
    openRecentSession: "الجلسات الأخيرة",
    ...
    projectContextAttached: "سياق المشروع النشط جاهز",
    projectContextIsAttached: "سياق المشروع مرفق",
    projectContextAttachedNoProcessedFiles: "مرفق، لكن لا توجد ملفات معالجة بعد",
    projectContextCouldNotBeLoaded: "تعذر تحميل سياق المشروع",
    projectPreviewDataUnavailable: "بيانات معاينة المشروع غير متاحة",
    checkZipProcessingStatus: "تحقق من حالة معالجة ZIP",
    projectContextNotAttached: "مشروع نشط متاح",
    noProjectContextAvailable: "لا يوجد مشروع متاح",
    attachThisProject: "أرفق هذا المشروع",
    attachedProject: "المشروع المرفق",
    assistantCanUseIndexedProjectContext: "يتم استخدام سياق المشروع الحالي للتحليل.",
    attachProjectToImproveProposals: "أرفق هذا المشروع لاستخدامه في هذه الدردشة.",
    responsesMayBeGeneralWithoutProjectContext: "لا يوجد سياق مشروع. ستكون الردود عامة.",
