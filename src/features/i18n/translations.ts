export const translations = {
  en: {
    ...
    projectContextAttached: "Attached",
    ...
    projectContextNotAttached: "Attach a project",
    ...
    attachProjectToImproveProposals: "Attach a project to improve proposals.",
  ...
  ar: {
    ...
    projectContextNotAttached: "أرفق مشروعًا",
    ...
    attachProjectToImproveProposals: "أرفق مشروعًا لتحسين المقترحات.",
