export const translations = {
  en: {
    ...
    projectContextAttachedNoProcessedFiles:
      "Project context is attached, but no processed files are available yet",
  ...
  ar: {
    ...
    projectContextIsAttached: "سياق المشروع مرتبط",
    projectContextAttachedNoProcessedFiles: "سياق المشروع مرتبط، لكن لا توجد ملفات معالجة بعد",
    projectContextCouldNotBeLoaded: "تعذر تحميل سياق المشروع",
    projectPreviewDataUnavailable: "بيانات معاينة المشروع غير متاحة",
    checkZipProcessingStatus: "تحقق من حالة معالجة ملف ZIP",
