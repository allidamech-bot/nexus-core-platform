...
export const mockFileTree: FileNode[] = [
  {
    ...
    type: "dir",
    children: [
      { id: "f1", name: "auth-gateway.ts", path: "src/auth-gateway.ts", type: "file", status: "modified" },
      { id: "f2", name: "session.shim.ts", path: "src/session.shim.ts", type: "file", status: "added" },
      {
        id: "routes",
        name: "routes",
        path: "src/routes",
