...
async function execute(input: {
  ...
  if (project.source_type === "github" && project.github_installation_id && project.github_repo_full_name) {
    try {
  ...
  return jsonResponse(
    {
      ...
      message: githubPrUrl ? "Working copy created and Pull Request opened" : "Working copy created",
