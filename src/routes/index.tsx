    ...
    <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          <Link to="/login" className="text-[13px] font-medium text-muted-foreground hover:text-foreground">Sign in</Link>
          <Link
            to="/signup"
    ...
    <header className="relative">
      ...
      <div className="relative mx-auto max-w-5xl pt-28 pb-24 px-6 text-center animate-entrance">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 text-pretty">
          An AI operating system for developers and businesses. Analyze projects, plan work,
          execute tasks, verify results, and manage workflows from one intelligent workspace.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link to="/signup" className="w-full sm:w-auto px-8 py-3 bg-foreground text-background font-semibold rounded-lg hover:bg-zinc-200 transition-colors inline-flex items-center justify-center gap-2">
            Start Building <ArrowRight className="size-4" />
          </Link>
          <a href="#platform" className="w-full sm:w-auto px-8 py-3 bg-white/5 border border-border font-semibold rounded-lg hover:bg-white/10 transition-colors">
            Watch Demo
          </a>
        </div>
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-28">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          <div className="font-mono text-[10px] text-accent uppercase tracking-widest mb-3">The problem</div>
          <h2 className="text-4xl font-bold tracking-tight mb-6">Chatbots generate. Operators execute.</h2>
          <p className="text-muted-foreground leading-relaxed">
            Most AI tools stop at suggestions. Your team is still left to inspect, plan, implement,
            and verify the work by hand. The cost of an unverified change is a regression,
            an outage, or a wrong report sent to a customer.
          </p>
        </div>
        <div className="space-y-3">
          {[
            ...
            <div key={p} className="flex items-start gap-3 p-4 rounded-lg border border-border bg-surface">
              <div className="size-5 mt-0.5 rounded-full border border-destructive/40 grid place-items-center text-destructive text-[11px] font-mono">!</div>
...
const features = [
  { icon: Terminal, title: "Engineering agent", body: "Analyze repositories, plan refactors, and propose patches with full file context." },
  { icon: Workflow, title: "Business workflow agent", body: "Design and run customer onboarding, sales reporting, and ops processes." },
  { icon: ShieldCheck, title: "Verification engine", body: "Every task ends with typecheck, lint, build, tests, and security scans." },
  { icon: GitBranch, title: "Project intelligence", body: "Upload ZIPs or connect repos. Stack detection, risks, and changed-file diffs." },
  { icon: Lock, title: "Approval gates", body: "Dangerous actions pause for human approval. Full audit log of every step." },
  { icon: Zap, title: "Multi-model routing", body: "Route tasks across reasoning, fast, and image models for the best result." },
];
  ...
  return (
    <section id="platform" className="mx-auto max-w-6xl px-6 py-28">
      <div className="text-center mb-16">
        <div className="font-mono text-[10px] text-accent uppercase tracking-widest mb-3">Platform</div>
        <h2 className="text-4xl font-bold tracking-tight mb-4">One workspace. Every operator.</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Nexus Core combines specialized agents, project intelligence, and a verification
          engine into a single execution surface.
        </p>
      </div>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {features.map((f) => (
          <div key={f.title} className="p-6 rounded-xl border border-border bg-surface hover:border-white/15 transition-colors">
...
const steps = [
  { n: "01", title: "Understand", body: "Restates intent, scopes the request, and pulls relevant project context." },
  { n: "02", title: "Plan", body: "Produces a concrete, numbered plan with risks and files in scope." },
  { n: "03", title: "Approve", body: "Pauses at approval gates for any destructive or irreversible action." },
  { n: "04", title: "Execute", body: "Runs the plan with a streaming execution log you can audit live." },
  { n: "05", title: "Verify", body: "Typecheck, lint, build, tests, security scan — every run, every time." },
  { n: "06", title: "Report", body: "Delivers a final report with changed files, diffs, and recommended next steps." },
];
...
function How() {
  return (
    <section id="workflow" className="border-y border-border bg-surface/40 py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-16">
          <div className="font-mono text-[10px] text-accent uppercase tracking-widest mb-3">How it works</div>
          <h2 className="text-4xl font-bold tracking-tight">A deterministic loop from prompt to proof.</h2>
        </div>
  ...
  return (
    <section id="security" className="mx-auto max-w-6xl px-6 py-28">
      <div className="grid md:grid-cols-[1fr_auto] gap-12 items-end mb-12">
        <div>
          <div className="font-mono text-[10px] text-accent uppercase tracking-widest mb-3">Security &amp; trust</div>
          <h2 className="text-4xl font-bold tracking-tight">Built for regulated environments.</h2>
        </div>
        <p className="text-sm text-muted-foreground max-w-md">
          Row-level access, full audit logs, approval gates, and sandboxed execution.
      ...
      <div className="grid md:grid-cols-4 gap-px bg-border rounded-xl overflow-hidden border border-border">
        {[
          ...
          <div key={x.k} className="p-6 bg-surface">
            ...
            <div className="mt-1 font-mono text-[11px] uppercase tracking-widest text-muted-foreground">{x.k}</div>
          </div>
        ))}
      </div>
    </section>
...
const plans = [
  { name: "Starter", price: "$49", per: "/mo", features: ["5 active sessions", "1 project", "Basic verification", "Community support"] },
  { name: "Pro", price: "$299", per: "/mo", features: ["Unlimited sessions", "10 projects", "Full verification suite", "Approval workflows", "Priority support"], featured: true },
  { name: "Business", price: "$999", per: "/mo", features: ["Team workspaces", "Audit logs export", "Business agents", "SSO", "SLAs"] },
  { name: "Enterprise", price: "Custom", per: "", features: ["Dedicated instance", "Private execution", "Compliance review", "Custom integrations"] },
];
...
function Pricing() {
  return (
    <section id="pricing" className="mx-auto max-w-6xl px-6 py-28">
      <div className="text-center mb-16">
        <div className="font-mono text-[10px] text-accent uppercase tracking-widest mb-3">Pricing</div>
...
const faqs = [
  { q: "Does Nexus Core actually execute code?", a: "Yes. The execution layer runs in sandboxed environments. Destructive actions pause at approval gates for human review." },
  { q: "What about my source code privacy?", a: "Your data is isolated per workspace with row-level security. Nothing is used to train shared models." },
  { q: "Can it run business workflows, not just engineering?", a: "Yes — dedicated Business, Research, and Workflow agents handle ops, sales, support, and reporting tasks." },
  { q: "Which AI models does it use?", a: "Nexus Core routes across multiple frontier models depending on task — reasoning, fast, and multimodal." },
];
    ...
    <section className="border-t border-border bg-surface/40 py-28">
      <div className="mx-auto max-w-3xl px-6">
        <div className="text-center mb-12">
          <div className="font-mono text-[10px] text-accent uppercase tracking-widest mb-3">FAQ</div>
    ...
    <footer className="border-t border-border">
      <div className="mx-auto max-w-6xl px-6 py-16 grid grid-cols-2 md:grid-cols-4 gap-12">
        <div className="col-span-2">
          <span className="text-sm font-bold tracking-tighter uppercase mb-4 block">Nexus Core</span>
