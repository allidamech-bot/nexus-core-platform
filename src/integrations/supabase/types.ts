    ...
    Tables: {
      ...
      plan_usage_limits: {
        Row: {
          ...
          max_sandbox_executions_monthly: number | null;
      ...
      project_working_copies: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "project_working_copies_request_id_fkey";
            columns: ["request_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "project_working_copies_snapshot_id_fkey";
            columns: ["snapshot_id"];
            isOneToOne: false;
            referencedRelation: "project_patch_snapshots";
            referencedColumns: ["id"];
      ...
      sandbox_execution_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "sandbox_execution_jobs_patch_preview_id_fkey";
            columns: ["patch_preview_id"];
            isOneToOne: false;
            referencedRelation: "project_patch_previews";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "sandbox_execution_jobs_project_id_fkey";
            columns: ["project_id"];
            isOneToOne: false;
            referencedRelation: "projects";
            referencedColumns: ["id"];
